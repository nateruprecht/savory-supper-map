...
const Map = () => {
  ...
  const states = [
    { id: 'Wisconsin', count: 65 },
    { id: 'Minnesota', count: 42 },
    { id: 'Michigan', count: 38 },
    { id: 'Illinois', count: 27 },
    { id: 'Iowa', count: 18 }
  ];
        ...
        <div className="container mx-auto px-4 py-6">
          ...
          <div className="mb-6">
            <Card className="bg-supper-cream/10 p-4 rounded-lg">
              ...
              <div className="relative mb-4">
                ...
                <Input
                  placeholder="Search for supper clubs..."
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-supper-cream/10 p-4 rounded-lg">
                ...
                {states.map(state => (
                  <motion.div
                    ...
                    className={`flex justify-between items-center p-3 rounded-lg cursor-pointer border ${
                      selectedState === state.id ? 'bg-supper-amber/20 border-supper-amber' : 'bg-white border-transparent hover:bg-supper-cream/20'
                    }`}
              ...
              <Button 
                variant="link" 
                className="mt-4 text-primary flex items-center justify-center w-full"
              >
            ...
            <div className="col-span-1 md:col-span-2 bg-white rounded-lg overflow-hidden shadow-sm h-[500px] relative">
              ...
              <div className="absolute inset-0 bg-supper-cream/20 flex items-center justify-center">
                <svg viewBox="0 0 400 300" width="100%" height="100%" className="p-8">
                  ...
                  <path 
                    ...
                    fill={selectedState === 'Wisconsin' ? '#E9C46A80' : '#E9C46A30'} 
                    stroke="#9D4B2E" 
                    strokeWidth="3"
                    className="cursor-pointer hover:fill-supper-amber/40"
                  ...
                  <path 
                    ...
                    fill={selectedState === 'Minnesota' ? '#E9C46A80' : '#E9C46A30'} 
                    stroke="#9D4B2E" 
                    strokeWidth="3"
                    className="cursor-pointer hover:fill-supper-amber/40"
                  ...
                  <path 
                    ...
                    fill={selectedState === 'Michigan' ? '#E9C46A80' : '#E9C46A30'} 
                    stroke="#9D4B2E" 
                    strokeWidth="3"
                    className="cursor-pointer hover:fill-supper-amber/40"
                  ...
                  <path 
                    ...
                    fill={selectedState === 'Illinois' ? '#E9C46A80' : '#E9C46A30'} 
                    stroke="#9D4B2E" 
                    strokeWidth="3"
                    className="cursor-pointer hover:fill-supper-amber/40"
                  ...
                  <path 
                    ...
                    fill={selectedState === 'Iowa' ? '#E9C46A80' : '#E9C46A30'} 
                    stroke="#9D4B2E" 
                    strokeWidth="3"
                    className="cursor-pointer hover:fill-supper-amber/40"
              ...
              {/* State info overlay */}
              {selectedState && (
                <div className="absolute top-4 left-4 bg-white p-3 rounded-lg shadow-sm border border-supper-amber/30">
